  ...
  <div class="question-card">
    <div class="question-header">
      <div class="header-left">
        ...
        <span :class="['source-badge', `source-${question.source}`]">{{ getSourceText(question.source) }}</span>
      </div>
...
.correct-answer { padding: 10px 15px; background: #d1fae5; border-left: 3px solid #10b981; border-radius: 6px; color: #065f46; font-size: 14px; font-weight: 500; margin-bottom: 15px; }
...
.source-badge { padding: 4px 12px; border-radius: 20px; font-size: 12px; font-weight: 600; }
.source-badge.source-manual { background: #e0e7ff; color: #3730a3; }
.source-badge.source-word { background: #dbeafe; color: #1e40af; }
.source-badge.source-ai { background: #fce7f3; color: #9f1239; }
.question-meta { display: flex; gap: 15px; padding-top: 12px; border-top: 1px solid #e5e7eb; }
