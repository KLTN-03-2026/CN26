    ...
    <div v-else>
      <header class="top-header">
        <div class="header-left">
          ...
          <p class="student-info">{{ result.userName }} - {{ result.examName }}</p>
        </div>
        ...
        <div v-for="(answer, index) in result.answers" :key="answer.id" class="answer-card">
          ...
          <div class="answer-body">
            <p class="question-text">
              <MathText :text="answer.questionContent" :auto-wrap="true" />
            </p>
            <div class="answer-options">
              <div v-for="opt in ['A', 'B', 'C', 'D']" :key="opt" 
                ...
                <span class="option-text">
                  <MathText :text="answer['option' + opt]" :auto-wrap="true" />
                </span>
              </div>
            </div>
